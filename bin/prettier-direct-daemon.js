#!/usr/bin/env node
// prettier-direct-daemon — composed entrypoint for prettier-direct.
// Composes node-formatter-daemon + adapters/prettier.
...
function die(msg) { console.error('[prettier-direct] fatal:', msg); process.exit(1); }
